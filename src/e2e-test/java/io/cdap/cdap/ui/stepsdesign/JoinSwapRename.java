...
public class JoinSwapRename {
    ...
    public void clickOnTheColumnIcon() {
        try {
            WaitHelper.waitForPageToLoad();
    ...
    public void clickOnTheRename() {
        try {
            WaitHelper.waitForPageToLoad();
            WaitHelper.waitForElementToBeDisplayed(Helper.locateElementByTestId("toolbar-icon-button-rename"));
            WebElement ele = SeleniumDriver.getDriver()
                    .findElement(By.xpath("//*[@data-testid='toolbar-icon-button-rename']"));
    ...
    public void clickOnTheNewColumnFieldAndEnterColumnName() {
        try {
            JavascriptExecutor js = (JavascriptExecutor) SeleniumDriver.getDriver();
            js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
            WaitHelper.waitForPageToLoad();
            WebElement field = SeleniumDriver.getDriver()
                    .findElement(By.xpath("//div//input[@data-testid='new-column-name-input']"));
            JavascriptExecutor executor = (JavascriptExecutor) SeleniumDriver.getDriver();
            executor.executeScript("arguments[0].click();", field);
            field.sendKeys("Google");
        } catch (Exception e) {
            System.err.println("error:" + e);
        }
    }
    ...
    public void clickOnTheJoinTwoColumn() {
        try {
            WaitHelper.waitForPageToLoad();
            WaitHelper.waitForElementToBeDisplayed(Helper.locateElementByTestId("toolbar-icon-button-join-columns"));
            WebElement ele = SeleniumDriver.getDriver()
                    .findElement(By.xpath("//*[@data-testid='toolbar-icon-button-join-columns']"));
            JavascriptExecutor executor = (JavascriptExecutor) SeleniumDriver.getDriver();
            executor.executeScript("arguments[0].click();", ele);
        } catch (Exception e) {
            System.err.println("error:" + e);
    ...
    public void selectTheDelimiterRadioButton() {
        try {
            WaitHelper.waitForPageToLoad();
            JavascriptExecutor js = (JavascriptExecutor) SeleniumDriver.getDriver();
            js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
            WebElement ele = SeleniumDriver.getDriver()
                    .findElement(By.xpath("//div//input[@data-testid='radio-option-6']"));
            JavascriptExecutor executor = (JavascriptExecutor) SeleniumDriver.getDriver();
            executor.executeScript("arguments[0].click();", ele);
        } catch (Exception e) {
            System.err.println("error:" + e);
    ...
    public void clickOnTheSwapTwoColumnNames() {
        try {
            WaitHelper.waitForPageToLoad();
            WaitHelper.waitForElementToBeDisplayed(Helper.locateElementByTestId("toolbar-icon-button-swap-columns"));
            WebElement ele = SeleniumDriver.getDriver()
                    .findElement(By.xpath("//*[@data-testid='toolbar-icon-button-swap-columns']"));
            JavascriptExecutor executor = (JavascriptExecutor) SeleniumDriver.getDriver();
            executor.executeScript("arguments[0].click();", ele);
        } catch (Exception e) {
            System.err.println("error:" + e);
