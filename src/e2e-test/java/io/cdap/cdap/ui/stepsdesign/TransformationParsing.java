...
public class TransformationParsing {
    ...
    @Then("Click on the Parse")
    public void clickOnTheParse() {
        try {
            WaitHelper.waitForPageToLoad();
            WaitHelper.waitForElementToBeDisplayed(Helper.locateElementByTestId("toolbar-icon-button-parse"));
            WebElement ele = SeleniumDriver.getDriver()
                    .findElement(By.xpath("//*[@data-testid='toolbar-icon-button-parse']"));
    ...
    @Then("Click on the CSV text")
    public void clickOnTheCSVText() {
        try {
            WaitHelper.waitForPageToLoad();
            WaitHelper.waitForElementToBeDisplayed(Helper.locateElementByTestId("toolbar-icon-button-parseCSV"));
            ElementHelper.clickOnElement(Helper.locateElementByTestId("toolbar-icon-button-parseCSV"));
        } catch (Exception e) {
            System.err.println("error:" + e);
        }
    }
