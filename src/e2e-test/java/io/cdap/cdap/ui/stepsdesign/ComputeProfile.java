...
public class ComputeProfile {
    ...
    public void openSystemProvisioner()  {
        ElementHelper.clickOnElement(Helper.locateElementByCssSelector(
                Helper.getCssSelectorByDataTestId("provisioner-gcp-dataproc")
        ));
    }

    @Then("Check that the Create button is disabled")
    public void createButtonDisableCheck()  {
        WebElement createBtn = Helper.locateElementByCssSelector(
                Helper.getCssSelectorByDataTestId("profile-create-btn"));
        if (createBtn.isEnabled()) {
            throw new RuntimeException("Create button is enabled but it should not be.");
        }
    }

    @Then("Add {string} as label")
    public void addInputLabel(String labelValue) {
        WebElement profileLabelInput = Helper.locateElementByCssSelector(
                Helper.getCssSelectorByDataTestId("profileLabel")
        );
    ...
    public void verifyNameAndLabelValues() {
        String addedLabel = ElementHelper.getElementText(
                Helper.locateElementByCssSelector(
                        Helper.getCssSelectorByDataTestId("profileLabel"))
        );
        String addedName = ElementHelper.getElementText(
                Helper.locateElementByCssSelector(
                        Helper.getCssSelectorByDataTestId("profileName"))
        );
        if (!addedLabel.equals(addedName)) {
            throw new RuntimeException("Profile name is not automatically filled with given label");
        }
    }

    @Then("Add {string} as Description")
    public void addTextAreaDescription(String descriptionValue) {
        WebElement descriptionTextarea = Helper.locateElementByCssSelector(
                Helper.getCssSelectorByDataTestId("profileDescription"));
    ...
    public void addInputProjectId(String projectIdValue) {
        WebElement projectIdInput = Helper.locateElementByCssSelector(
                Helper.getCssSelectorByDataTestId("projectId")
        );
    ...
    public void addInputAccountKey(String accountKeyValue) {
        WebElement accountKeyInput = Helper.locateElementByCssSelector(
                Helper.getCssSelectorByDataTestId("accountKey"));
