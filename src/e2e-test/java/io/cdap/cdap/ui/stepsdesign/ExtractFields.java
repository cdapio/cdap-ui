...
public class ExtractFields {
    ...
    public void clickOnTheExtract() {
        try {
            WaitHelper.waitForPageToLoad();
            WaitHelper.waitForElementToBeDisplayed(Helper.locateElementByTestId("menu-item-extract"));
            WebElement ele = SeleniumDriver.getDriver()
                    .findElement(By.xpath("//*[@data-testid='menu-item-extract']"));
    ...
    public void clickOnTheUsingPatterns() {
        try {
            WaitHelper.waitForPageToLoad();
            WaitHelper.waitForElementToBeDisplayed(Helper.locateElementByTestId("menu-item-extract-using-patterns"));
            ElementHelper.clickOnElement(Helper.locateElementByTestId("menu-item-extract-using-patterns"));
        } catch (Exception e) {
            System.err.println("error:" + e);
        }
    }
    ...
    public void clickOnSelectAPatternInputField() {
        try {
            WaitHelper.waitForPageToLoad();
    ...
    public void clickOnTheUsingDelimiters() {
        try {
            WaitHelper.waitForPageToLoad();
            WaitHelper.waitForElementToBeDisplayed(Helper.locateElementByTestId("menu-item-extract-using-delimiters"));
            ElementHelper.clickOnElement(Helper.locateElementByTestId("menu-item-extract-using-delimiters"));
        } catch (Exception e) {
            System.err.println("error:" + e);
        }
    }
    ...
    public void clickOnTheUsingPositions() {
        try {
            WaitHelper.waitForPageToLoad();
            WaitHelper.waitForElementToBeDisplayed(Helper.locateElementByTestId("menu-item-extract-using-positions"));
            ElementHelper.clickOnElement(Helper.locateElementByTestId("menu-item-extract-using-positions"));
        } catch (Exception e) {
            System.err.println("error:" + e);
        }
    }
