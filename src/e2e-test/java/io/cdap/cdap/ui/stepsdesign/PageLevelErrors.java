...
public class PageLevelErrors {
  ...
  public void openFakeNamespaceMetadataPage() {
    SeleniumDriver.openPage(Constants.BASE_URL + "/cdap/ns" + fakeNamespace + "/metadata");
    WaitHelper.waitForPageToLoad();
  }

  @When("Open fake namespace search results page")
  public void openFakeNamespaceSearchResultsPage() {
    SeleniumDriver.openPage(Constants.BASE_URL + "/cdap/ns" + fakeNamespace + "/metadata/search/search_term/result");
    WaitHelper.waitForPageToLoad();
  }
