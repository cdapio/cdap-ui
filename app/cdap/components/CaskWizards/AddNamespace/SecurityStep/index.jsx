...
const mapStateToPrincipalProps = (state) => {
  return {
    ...
    placeholder: T.translate(
      'features.Wizard.Add-Namespace.SecurityStep.principal-placeholder'
    ),
...
const mapStateTokeytabURIProps = (state) => {
  return {
    ...
    type: 'text',
    placeholder: T.translate(
      'features.Wizard.Add-Namespace.SecurityStep.keytab-uri-placeholder'
    ),
      ...
      >
        <FormGroup row>
          <Col xs="3">
            <Label className="control-label">
              {T.translate(
                'features.Wizard.Add-Namespace.SecurityStep.principal-label'
              )}
            </Label>
          </Col>
          <Col xs="7">
        ...
        <FormGroup row>
          <Col xs="3">
            <Label className="control-label">
              {T.translate(
                'features.Wizard.Add-Namespace.SecurityStep.keytab-uri-label'
              )}
            </Label>
          </Col>
          <Col xs="7">
