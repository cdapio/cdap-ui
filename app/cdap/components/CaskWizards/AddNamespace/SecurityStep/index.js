...
const mapStateToPrincipalProps = (state) => {
  return {
    ...
    type: 'text',
    placeholder: T.translate('features.Wizard.Add-Namespace.Step5.principal-placeholder'),
...
const mapStateTokeytabURIProps = (state) => {
  return {
    ...
    type: 'text',
    placeholder: T.translate('features.Wizard.Add-Namespace.Step5.keytab-uri-placeholder'),
    ...
    <Provider store={AddNamespaceStore}>
      ...
      >
        <FormGroup row>
          <Col xs="3">
            <Label className="control-label">
              {T.translate('features.Wizard.Add-Namespace.Step5.principal-label')}
            </Label>
          </Col>
          <Col xs="7">
            <InputPrincipal />
        ...
        <FormGroup row>
          <Col xs="3">
            <Label className="control-label">
              {T.translate('features.Wizard.Add-Namespace.Step5.keytab-uri-label')}
            </Label>
          </Col>
          <Col xs="7">
            <InputKeytabURI />
