...
import { addTestIdBySelector } from 'components/StudioV2/utils/domUtils';
...
export function DagComponent({
  ...
  function connectionToDagEdge(conn): Edge {
    ...
    const edge: Edge = {
      ...
      className: 'jsplumb-connector', // required to keep the same tests work on both old and new UIs
    };
