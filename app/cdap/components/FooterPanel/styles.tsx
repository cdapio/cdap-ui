...
export const CommonColumnViewBox = styled(Box)`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: flex-start;
...
export const DisabledColumnViewBox = styled(CommonColumnViewBox)`
  pointer-events: none;
`;

export const NormalColumnViewBox = styled(CommonColumnViewBox)`
  pointer-events: auto;
`;

export const getColumnViewBoxStyle = (isDisabled) => {
