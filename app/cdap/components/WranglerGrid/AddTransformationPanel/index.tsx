...
export default function({
  ...
  useEffect(() => {
    setTransformationComponentsValue({
      ...transformationComponentValues,
      firstColumn: selectedColumns.length >= 1 ? selectedColumns[0].label : '',
      secondColumn: selectedColumns.length === 2 ? selectedColumns[1].label : '',
    });
        ...
        <DrawerContainerBox role="presentation" data-testid="add-transformation-drawer">
          ...
          <AddTransformationWrapper>
            <AddTransformationBodyWrapper>
              ...
              <Divider />
              <FunctionNameWidget transformationName={transformationName} transformationLink={transformationLink}/>
              <SelectColumnsWidget
