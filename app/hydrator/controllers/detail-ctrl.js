...
export const PipeDetailsCtrl = function($rootScope, PipelineAvailablePluginsActions, GLOBALS, myHelpers, HydratorPlusPlusHydratorService, DAGPlusPlusNodesStore, MyPipelineDetail) {
  // FIXME: This should essentially be moved to a scaffolding service that will do stuff for a state/view
  var $scope = $rootScope.$new(true, undefined);
  const rPipelineDetail = MyPipelineDetail;
  ...
  this.appInfo = {namespace: $stateParams.namespace, pipelineId: window.location.pathname.split('view/')[1]};
...
angular.module(PKG.name + '.feature.hydrator')
  .controller('HydratorPlusPlusDetailCtrl', PipeDetailsCtrl)