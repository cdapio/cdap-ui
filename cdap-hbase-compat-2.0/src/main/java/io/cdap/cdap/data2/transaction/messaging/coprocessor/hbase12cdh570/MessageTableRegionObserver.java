 ...
 *
 */
public class MessageTableRegionObserver implements RegionObserver, RegionCoprocessor {
  ...
  public InternalScanner preFlush(ObserverContext<RegionCoprocessorEnvironment> c, Store store,
    ...
    return new LoggingInternalScanner("MessageDataFilter", "preFlush",
                                      new FilterInternalScanner(scanner, filter),
                                      txVisibilityState);
  }

  @Override
  public void postFlush(ObserverContext<RegionCoprocessorEnvironment> c, FlushLifeCycleTracker tracker) {
  ...
  public InternalScanner preCompact(ObserverContext<RegionCoprocessorEnvironment> c, Store store,
    ...
    return new LoggingInternalScanner("MessageDataFilter", "preCompact",
                                      new FilterInternalScanner(scanner, filter), txVisibilityState);
  }
