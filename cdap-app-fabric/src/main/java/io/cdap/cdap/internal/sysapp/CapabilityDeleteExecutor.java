...
/**
 * CapabilityDeleteExecutor
 */
public class CapabilityDeleteExecutor implements CapabilityActionExecutor {
  private CapabilityManager capabilityManager;

  @Inject
  public CapabilityDeleteExecutor(CapabilityManager capabilityManager) {
  ...
  public void execute(CapabilityStep capabilityStep) {
    ...
    try {
      boolean hasChanged = null == capabilityManager.getCapabilityStatus(capability);
      if (hasChanged) {
        //TODO - full steps
        // Update status
        // delete pipelines
